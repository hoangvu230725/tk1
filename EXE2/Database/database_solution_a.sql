...
-- 9. Lấy ra danh sách người dùng trong đó tên người dùng có chữ 'a', chiều dài từ 5 đến 9, email dùng Gmail, và trong tên email có chữ 'I'
SELECT * FROM users 
...
-- 10. Lấy ra danh sách người dùng trong đó tên người dùng có chữ 'a', chiều dài từ 5 đến 9 
-- hoặc tên người dùng có chữ 'i', chiều dài nhỏ hơn 9 hoặc email dùng Gmail, trong tên email có chữ 'i'
SELECT * FROM users 
WHERE 
